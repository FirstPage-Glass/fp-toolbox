...
export const projects: Project[] = [
  ...
  {
    slug: "invoice-list-am-review",
    name: "Invoice List for AM Review",
    category: "Automation",
    description: "Generate invoice lists for Account Manager review with client grouping and sorting. Produces Excel files for the Invoice Review Web App.",
    ...
    repoUrl: null,
    hasWebUi: false,
    before: "Finance manually prepared invoice lists for each AM — client grouping done by hand, frequent sorting errors",
    after: "Automated grouping and sorting → Clean Excel output ready for the Invoice Review System",
    flow: "Raw Invoice Data → Client Grouping → AM Assignment → Sorting → Excel Output → Invoice Review System",
    aiModels: [],
    impact: "Pre-structured invoice lists eliminate manual grouping for 16 AMs",
  ...
  {
    slug: "invoice-list-twice-monthly",
    name: "Invoice List Twice Monthly",
    category: "Automation",
    description: "Twice-monthly invoice list generation (15th and end-of-month) for AM distribution with commission eligibility tracking.",
    techStack: ["Python", "openpyxl", "Resend"],
    integrations: ["Resend"],
    status: "Prototype",
    url: null,
    repoUrl: null,
    hasWebUi: false,
    before: "Finance manually compiled twice-monthly invoice lists and calculated commission eligibility — spreadsheets prone to errors",
    after: "Scheduled auto-generation on 15th and month-end → Commission eligibility flagged → Distribution list ready",
    flow: "Schedule Trigger → Invoice Data Pull → Commission Eligibility Check → AM Grouping → Excel + Email Output",
    aiModels: [],
    impact: "Twice-monthly automated invoice list generation with commission tracking",
...
export const teamImpact = {
  ...
  "Accounts & Finance": {
    projects: ["invoice-review", "overdue-reports", "invoice-list-am-review", "invoice-list-twice-monthly", "invoice-email"],
